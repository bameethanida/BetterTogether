# Generated by Django 2.2.5 on 2019-12-13 13:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('location_name', models.TextField(default='', max_length=80, verbose_name='Location Name')),
                ('location', models.TextField(default='', max_length=80, verbose_name='Location')),
                ('destination_name', models.TextField(default='', max_length=80, verbose_name='Destination Name')),
                ('destination', models.TextField(default='', max_length=80, verbose_name='Destination')),
                ('description', models.TextField(default='', max_length=100, verbose_name='Description')),
                ('date_time', models.DateTimeField(default='2019-12-13 20:40:10', verbose_name='Date and Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_name', models.TextField(default='', max_length=80, verbose_name='Location Name')),
                ('location', models.TextField(default='', max_length=80, verbose_name='Location')),
                ('brand', models.TextField(default='', max_length=80, verbose_name='Brand')),
                ('description', models.TextField(default='', max_length=100, verbose_name='Description')),
